...
class Transaction:
    ...
    def create_output(self, sender_wallet, recipient, amount):
        ...
        # To know how much currency sender has after transaction, the change
    ...
    def create_input(self, sender_wallet, output):
        ...
        Also signs the transaction and include the senders public key
        and address.
        """
        return {
    ...
    def from_json(transaction_json):
        """
        Deserialize the transactions json representation back into a transaction instance.
        """
...
def main():
    transaction = Transaction(
        sender_wallet=Wallet(), recipient='recipient', amount=15)
